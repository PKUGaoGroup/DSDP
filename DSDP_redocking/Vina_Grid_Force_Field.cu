...
//vina atom type
// X-Score
//const sz XS_TYPE_C_H = 0;//_Hָ����ˮ ������ֻ�е�C������C��Hʱ����C��ΪC_H
...
//const sz XS_TYPE_Met_D = 16;//�������Ӧ���ǽ���ԭ��ͨ������
//const sz XS_TYPE_SIZE = 17;//�ڳ�����������ԭ�Ӷ��Ǹ�����
...
void VINA_GRID_FORCE_FIELD::GRID::Cuda_Texture_Initial(VINA_GRID_FORCE_FIELD* vgff)
{
	...
	texDesc.borderColor[3] = 10.e6f;//���߽�ʱ��һ����������ϣ����Щ�������Ǳ��ܽ�
